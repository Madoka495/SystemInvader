...
public class Tower
{
    ...
    public void Shoot(Vector2 enemyPosition, ContentManager content)
    {
        ...
        {
            _projectiles.Add(new Projectile(_position, enemyPosition, 24, 12, content.Load<Texture2D>("Sprites/bullet8"), 2));
        }
        else if (_type == 4)
        {
        ...
        {
            _projectiles.Add(new Projectile(_position, enemyPosition, 8, 12, content.Load<Texture2D>("Sprites/bullet9"), 4));
        }
    }
