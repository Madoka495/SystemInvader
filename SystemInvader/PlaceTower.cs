...
namespace SystemInvader
{
    public class PlaceTower
    {
        ...
        public PlaceTower(Player player, Level level, ContentManager content)
        {
            ...
            _2ndEvolutions.Add(new Tower(new Vector2(780, 755), content.Load<Texture2D>("Sprites/tower2-3"), new List<Tower>(), 14, 400, 20, 16, 500, 8, "Elemental bullets ! This portal can fire\r\nbullets with different effects.", content.Load<SoundEffect>("Sound/Effect/shoot"), _player));
            _evolutions.Add(new Tower(new Vector2(710, 749), content.Load<Texture2D>("Sprites/tower2-2"), _2ndEvolutions, 16, 400, 18, 12, 300, 7, "Bullets from another dimension...\r\nFaster and stronger than the previous\r\nones.", content.Load<SoundEffect>("Sound/Effect/shoot"), _player));
